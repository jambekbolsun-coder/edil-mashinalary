...
export default async function BlogArticlePage({ params }: PageProps) {
  const { slug } = await params;
  const [post, blogPosts] = await Promise.all([getBlogPost(slug), getBlogPosts()]);
  if (!post) notFound();
